...
import { ChevronRight, Globe, Bell, Shield, Lock, Clock } from 'lucide-react';
...
const ScoutSettingsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0c1f] text-slate-100 pb-12 font-sans">
      <div className=" mx-auto px-5 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex gap-8 text-sm font-medium">
            <button
              ...
              className={`pb-4 px-1 relative ${
                activeTab === 'security'
                  ? 'text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-teal-500'
        ...
        {activeTab === 'security' && (
          <div className="space-y-10">
            ...
            {/* Change Password */}
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl p-6 md:p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0a0c1f] border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-teal-500/60"
                  />
                </div>
            ...
            {/* Privacy Settings */}
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl overflow-hidden">
            ...
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl overflow-hidden">
              ...
              <div className="p-6 md:p-8 space-y-5">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between bg-[#0a0c1f] border border-slate-800 rounded-lg px-5 py-4"
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center text-teal-400">
                        {session.icon === "laptop" ? <Clock size={20} /> : <Clock size={20} />}
                      </div>
                      <div>
                    ...
                    {i === 1 && (
                      <button className="text-red-400 hover:text-red-300 text-sm">×</button>
                    )}
                  </div>
                ))}

                <button className="w-full mt-4 py-3 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg transition-colors">
        ...
        {activeTab === 'notifications' && (
          <div className="space-y-10">
            ...
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl overflow-hidden">
              ...
              <div className="divide-y divide-slate-800/70">
                {[
                  { label: "New Player Matches", desc: "Get notified when new players match your search criteria", key: "emailNewMatches" },
                  { label: "Event Updates", desc: "Receive updates about upcoming scouting events", key: "emailEventUpdates" },
                  { label: "Player Profile Views", desc: "Know when players view your profile", key: "emailPlayerViews" },
                  { label: "Message Notifications", desc: "Get notified about new messages", key: "emailMessages" },
                  { label: "Weekly Summary", desc: "Receive a weekly summary of your activity", key: "emailWeeklySummary" },
                  { label: "Platform Updates", desc: "Stay informed about new features and updates", key: "emailPlatformUpdates" },
                ].map(item => (
                  <div key={item.label} className="flex items-center justify-between px-6 md:px-8 py-5">
                    <div>
            ...
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl overflow-hidden">
              ...
              <div className="divide-y divide-slate-800/70">
                {[
                  { label: "Instant Messages", desc: "Real-time notifications for new messages", key: "pushInstantMessages" },
                  { label: "Event Reminders", desc: "Reminders before scouting events", key: "pushEventReminders" },
                  { label: "Shortlist Updates", desc: "When shortlisted players update their profiles", key: "pushShortlistUpdates" },
                ].map(item => (
                  <div key={item.label} className="flex items-center justify-between px-6 md:px-8 py-5">
                    <div>
                      <p className="font-medium">{item.label}</p>
            ...
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl overflow-hidden">
              ...
              <div className="divide-y divide-slate-800/70">
                {[
                  { label: "Security Alerts", desc: "Important security notifications", key: "smsSecurityAlerts" },
                  { label: "Login Verification", desc: "Two-factor authentication codes", key: "smsLoginVerification" },
                ].map(item => (
                  <div key={item.label} className="flex items-center justify-between px-6 md:px-8 py-5">
                    <div>
                      <p className="font-medium">{item.label}</p>
          ...
          <div className="space-y-10">
            ...
            <div className="bg-[#11152b] border border-slate-800/70 rounded-xl p-6 md:p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-slate-400 text-sm mb-2">Platform language</label>
                  <select className="w-full bg-[#0a0c1f] border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-teal-500/60">
                ...
                <div>
                  <label className="block text-slate-400 text-sm mb-2">Time Zone</label>
                  <select className="w-full bg-[#0a0c1f] border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-teal-500/60">
                ...
                <div>
                  <label className="block text-slate-400 text-sm mb-2">Date Format</label>
                  <select className="w-full bg-[#0a0c1f] border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-teal-500/60">
              ...
              <div className="divide-y divide-slate-800/70">
                <div className="flex items-center justify-between px-6 md:px-8 py-5">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm mt-0.5">Remember your recent searches and filters</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                ...
                <div className="flex items-center justify-between px-6 md:px-8 py-5">
                  <div>
                    <p className="font-medium">Search Suggestions based on activity</p>
                    <p className="text-slate-400 text-sm mt-0.5">Show suggested players based on your activity</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
