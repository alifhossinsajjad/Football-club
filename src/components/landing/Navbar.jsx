...
//               width={140}
//               height={24}
//               className="w-[90px] sm:w-[110px] md:w-[130px] lg:w-[140px] h-auto"
//               priority
//             />
//           </div>
...
//           {/* Desktop Buttons */}
//           <div className="hidden lg:flex items-center gap-3">
//             <button className="px-6 py-1.5 border border-[#084559] text-white rounded-full font-medium w-28">
//               Log in
//             </button>
...
//             <button
//               className="px-2 rounded-md w-12 h-8 flex items-center justify-center"
...
//               <div className="flex gap-3 pt-4">
//                 <button className="flex-1 py-2 border border-[#084559] rounded-full text-white">
//                   Log in
//                 </button>
//                 <button className="flex-1 py-2 border border-[#084559] rounded-full text-white">
//                   Sign up
