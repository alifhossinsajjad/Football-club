            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-20 lg:h-24">
                    ...
                    <div
                        ...
                        style={{
                            borderColor: `${theme.colors.primaryCyan}1A`, // semi-transparent cyan
                        }}
                    >
                        <Image
                            src="/logo.png"
                    ...
                    <div className="hidden lg:flex items-center gap-3">
                        ...
                        <button className="px-2 text-primary rounded-md transition w-12 h-8 flex items-center justify-center"
                            style={{
