...
export default function EditCategoryPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    color: '#00E5FF',
    parentCategory: '',
    metaTitle: 'Training - Football Pros News',
  ...
  const recentArticles = [
    {
      title: 'Top 10 Training Drills',
      views: '3,245 views'
    },
    {
      title: 'Essential Training Equipment',
      views: '2,891 views'
    }
  ]
          ...
          >
            ...
            >
              <div className="flex flex-col items-center text-center mb-4">
                ...
                <p className="text-sm text-gray-400 mb-3">{formData.description}</p>
                <span 
            ...
            <div className="space-y-3">
              {recentArticles.map((article, index) => (
                ...
                >
                  ...
                  <p className="text-xs text-gray-400">{article.views}</p>
                </div>
              ))}
            </div>
          </div>
