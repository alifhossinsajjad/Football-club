...
import { ArrowLeft, Upload, Bold, Italic, Underline, Heading1, Heading2, Heading3, Link as LinkIcon, Image as ImageIcon, List, Save } from 'lucide-react'
...
export default function EditArticlePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    excerpt: '',
    content: 'Is 0 strikers to fn-prove In we Cover tho\nused by Each focuses on improving speed, accuracy, positioning and\nthe\n\nINt0 specific drifts, crucial to understnnd what makes 0 striker. The best in the world\ntechmm toctical and\n\nThe Top 10 Traini:g Drills\n\nLnrst-ling\n\nThis drill sin.14Atos gamo situations whore you\'re through on goal with just the goalkeeper to bmt. ProotfGG different finishing\ntGchnquos including crup smts, power smts, and placorrsnt srsts. Aim for at toast 20\n\n### 2. Quick mm and Srmt\n\nReceive the ball with your back to goal, turn quict.ly, md Sreat with in two touches. This ability to Create\nopportummas tight\n\n3. Header Practice\n\nHoacting is a critical Skill for my striker. Practice hoaoxs crosses, both noar and post wert on\nthe bon With occuracy, and generating powe:. Include both standing and',
    metaDescription: '',
    tags: 'training, drills, striker, youth, football, techniques',
    publishStatus: 'draft'
  })
