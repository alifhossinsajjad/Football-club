...
const settingsTabs = [
  { path: '/admin/settings/general', icon: SettingsIcon, label: 'General' },
  { path: '/admin/settings/user-management', icon: Users, label: 'User Management' },
  { path: '/admin/settings/monetization', icon: CreditCard, label: 'Monetization' },
  { path: '/admin/settings/notifications', icon: Bell, label: 'Notifications' },
]
  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <div>
        ...
        <p className="text-sm lg:text-base text-gray-400">Manage your platform</p>
      </div>
